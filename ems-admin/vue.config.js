...
const name = defaultSettings.title || "考试管理系统"; // page title

// If your port is set to 80,
// use administrator privileges to execute the command line.
// For user, Mac: sudo npm run
...
module.exports = {
   ...
   * for user GitHub Pages. If you plan to deploy your site to https://foo.github.io/bar/,
